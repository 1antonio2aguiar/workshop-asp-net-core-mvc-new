...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(2, "vetuário");
            Department d3 = new Department(3, "Cama Mesa Banho");
            Department d4 = new Department(4, "Eletrodomésticos");
            Department d5 = new Department(5, "Móveis");

            // Vendedores
            Seller s1 = new Seller(1, "Maria Batriz", "bia@gmail.com", new DateTime(199, 04, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Ana Maria", "ana@gmail.com", new DateTime(1957, 03, 25), 3500.0, d2);
            Seller s3 = new Seller(3, "Rita Cassia", "ana@gmail.com", new DateTime(1965, 05, 26), 2200.0, d1);
            Seller s4 = new Seller(4, "José Geraldo", "jg@gmail.com", new DateTime(1960, 12, 12), 3000.0, d4);
            Seller s5 = new Seller(5, "Paulo Cesar", "pc@gmail.com", new DateTime(1978, 11, 3), 4000.0, d3);
            Seller s6 = new Seller(6, "Carlos Antonio", "ca@gmail.com", new DateTime(1977, 08, 15), 3000.0, d5);
